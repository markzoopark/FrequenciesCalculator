...
class ModeVMinus extends StatefulWidget {
  @override
  _ModeVMinusState createState() => _ModeVMinusState();
}

class _ModeVMinusState extends State<ModeVMinus> {
